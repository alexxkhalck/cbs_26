...
1. Створіть форк від репозиторію викладача на [github](https://github.com/). Це буде ваш робочий репозиторій.
...
4. Створіть нову гілку, яка буде використовуватись для змін, за допомогою команди `git checkout -b homework<number>`. Можна також використовувати формат: назва_дз_номер_лекції.
...
7. Додайте внесені зміни до стейджингу за допомогою команди `git add <filepath>.py`
